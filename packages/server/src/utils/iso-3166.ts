...
/**
 * Check country code is valid ISO-31661-Alpha2
 * @param string Country Code
 */
export default function isISO31661Alpha2 (string: string): boolean {
  return validISO31661Alpha2CountriesCodes.has(string.toUpperCase())
}
